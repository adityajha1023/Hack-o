    ...
    return (
        <div className='flex flex-col justify-between items-start gap-8 px-20 py-10'>
            ...
            <div className='flex flex-row justify-evenly items-center flex-wrap w-full'>
                <div className='bg-white py-6 px-8 rounded-3xl min-h-[60vh] max-w-[25rem] flex flex-col justify-start items-start gap-6 shadow-md'>
                ...
                <div className='bg-white py-6 px-8 rounded-3xl min-h-[60vh] max-w-[25rem] flex flex-col justify-start items-start gap-6 shadow-md'>
                    ...
                    <h3 className='text-h4 text-black/50 font-medium'><span className='text-black font-semibold'>60</span> teams compete in a 24-hour on-campus hackathon</h3>
